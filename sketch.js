 ...
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   switch(select_balloon){
    case 1:redBalloon() //chamar o balãovermelho
    break;
    case 2:blueBalloon()//chamar o balãoazul
    break;
    case 3:greenBalloon()//chamar o balãoverde
    break;
    case 4:pinkBalloon()//chamar o balãorosa
break;
